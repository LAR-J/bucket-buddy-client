...
/***/ function(module, exports, __webpack_require__) {
	...
	var homePageEvents = __webpack_require__(8);
	var bucketEvents = __webpack_require__(9);
	var userEvents = __webpack_require__(36);
	var profileEvents = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  if (data.passwords.old === data.passwords.new) {
	    ...
	    api.changePassword(data).done(ui.changePasswordSuccess).fail(ui.changPasswordFailure);
	  } else {
...
/***/ function(module, exports) {
	...
	var app = {
	  host: 'https://bucket-buddy-api.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var homePageHandlers = function homePageHandlers() {
	...
	var hideHomePage = function hideHomePage() {
	  $(".hide-homescreen").hide();
	};
	...
	module.exports = {
	  homePageHandlers: homePageHandlers,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bucketPageHandlers = function bucketPageHandlers() {
	...
	var onCreateBucket = function onCreateBucket(event) {
	  ...
	  api.createBucket(data).then(ui.createBucketSuccess).then(onUserBuckets).catch(function (error) {
	    return console.error(error);
	  });
	};

	var onShowBucket = function onShowBucket() {
	  return api.showBucket().then(ui.showBucketSuccess).catch(function (error) {
	    return console.error(error);
	  });
	};

	var onUserBuckets = function onUserBuckets() {
	  return api.showUserBuckets().then(ui.showUserBucketsSuccess).then(function () {
	...
	var onAllUserBuckets = function onAllUserBuckets() {
	  return api.showAllUserBuckets().then(ui.showAllBucketsSuccess).catch(function (error) {
	    return console.error(error);
	  });
	};
	...
	var onUpdateBucket = function onUpdateBucket(event) {
	  event.preventDefault();
	  var buttonId = $(event.target).find('.save-bucket-button').attr('data-id');
	  // console.log(buttonId);
	  var data = getFormFields(event.target);
	  api.updateBucket(data, buttonId).then(ui.updateBucketSuccess).then(onUserBuckets).catch(function (error) {
	    return console.error(error);
	  });
	};
	...
	var onEditBucket = function onEditBucket(event) {
	  ...
	  .then(ui.showBucketSuccess).then(function () {
	...
	var onDeleteBucket = function onDeleteBucket(event) {
	  event.preventDefault();
	  var buttonId = $(event.target).attr('data-id');
	  api.deleteBucket(buttonId).then(ui.deleteBucketSuccess).then(onUserBuckets).catch(function (error) {
	    return console.error(error);
	  });
	};
	...
	var hideUsersBuckets = function hideUsersBuckets() {};

	var addBucketHandlers = function addBucketHandlers() {
	...
	//
	module.exports = {
	  addBucketHandlers: addBucketHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createBucket = function createBucket(data) {
	...
	var updateBucket = function updateBucket(data, id) {
	  return new Promise(function (resolve, reject) {
	    $.ajax({
	...
	var showBucket = function showBucket(id) {
	  return new Promise(function (resolve, reject) {
	    $.ajax({
	      url: app.host + '/buckets/' + id,
	      method: 'GET',
	...
	var showUserBuckets = function showUserBuckets() {
	  return new Promise(function (resolve, reject) {
	    $.ajax({
	...
	var showAllUserBuckets = function showAllUserBuckets() {
	  return new Promise(function (resolve, reject) {
	    $.ajax({
	...
	module.exports = {
	  ...
	  showUserBuckets: showUserBuckets,
	  showAllUserBuckets: showAllUserBuckets,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var api = __webpack_require__(10);
	var bucketTemplate = __webpack_require__(12);
	var updateBucketTemplate = __webpack_require__(33);
	var allBucketsTemplate = __webpack_require__(34);

	var createBucketSuccess = function createBucketSuccess(data) {
	  app.bucket = data.bucket;
	  $(".modal-fullscreen.create-bucket").modal('hide');
	};

	var createBucketFailure = function createBucketFailure(error) {
	  console.error(error);
	};

	var updateBucketFailure = function updateBucketFailure(error) {
	  console.error(error);
	};

	var showBucketSuccess = function showBucketSuccess(data) {
	  app.bucket = data.bucket;
	...
	var showAllBucketsSuccess = function showAllBucketsSuccess(data) {
	  // console.log(data);
	  $('#user-profile').html('');
	  $('#user-buckets').html('');
	...
	var showBucketFailure = function showBucketFailure(error) {
	  console.error(error);
	};

	var showUserBucketsSuccess = function showUserBucketsSuccess(data) {
	...
	var deleteBucketSuccess = function deleteBucketSuccess() {
	  // console.log('Bucket deleted successfully');
	  app.bucket = null;
	};

	var updateBucketSuccess = function updateBucketSuccess(data) {
	  $(".modal-fullscreen.update-bucket").modal('hide');
	};

	var deleteBucketFailure = function deleteBucketFailure(error) {
	  console.error(error);
	};

	module.exports = {
	  createBucketSuccess: createBucketSuccess,
	  createBucketFailure: createBucketFailure,
	  updateBucketSuccess: updateBucketSuccess,
	  updateBucketFailure: updateBucketFailure,
	  showBucketSuccess: showBucketSuccess,
	  showBucketFailure: showBucketFailure,
	  showUserBucketsSuccess: showUserBucketsSuccess,
	  deleteBucketSuccess: deleteBucketSuccess,
	  deleteBucketFailure: deleteBucketFailure,
	  showAllBucketsSuccess: showAllBucketsSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(32),depth0,{"name":"bucket","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.buckets : depth0), depth0),{"name":"buckets","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\n\n<!-- this.attr(data id) -->\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"contents col-md-4\">\n    <h4 class=\"uppercase\">"
	    ...
	    + "\n      </div>\n      <div class=\"individual-items\">\n        Let's get this done by the time I'm "
	    ...
	    + "\n      </div>\n      <div class=\"bucketEditDeleteButtons\">\n        <button type=\"submit\" class=\"delete-bucket-button btn btn-default\" id=\""
	    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
	    + "\" data-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">Delete</button>\n        <button type=\"submit\" class=\"edit-bucket-button btn btn-default\" id=\""
	    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
	    + "\" data-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#modal-fullscreen-update-bucket\">Update</button>\n      </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<form id=\"submit-bucket-edits\">\n  <fieldset>\n    <div>\n      title: <input class=\"form-control\" type=\"text\" name=bucket[title] placeholder=\"Title of Bucket\" value=\""
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "\">\n    </div>\n    <div>\n      description: <input class=\"form-control\" type=\"text\" name=bucket[description] placeholder=\"Description of Bucket\" value=\""
	    + alias4(((helper = (helper = helpers.description || (depth0 != null ? depth0.description : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"description","hash":{},"data":data}) : helper)))
	    + "\" />\n    </div>\n    <div>\n      category: <label for=\"selectcategory\">Category</label>\n      <select name=\"bucket[category]\" class=\"form-control\" id=\"selectcategory\">\n        <option>Pick a category</option>\n        <option value=\"culture\">Culture</option>\n        <option value=\"entertainment\">Entertainment</option>\n        <option value=\"family\">Family</option>\n        <option value=\"food\">Food</option>\n        <option value=\"outdoor\">Outdoor</option>\n        <option value=\"shopping\">Shopping</option>\n        <option value=\"sport\">Sport</option>\n        <option value=\"travel\">Travel</option>\n        <option value=\"work\">Work</option>\n      </select>\n    </div>\n    <div>\n      link to website: <input type=\"text\" name=\"bucket[link]\" class=\"form-control\" value=\""
	    + alias4(((helper = (helper = helpers.link || (depth0 != null ? depth0.link : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"link","hash":{},"data":data}) : helper)))
	    + "\" />\n    </div>\n    <div>\n      age you want to acheive this by: <input type=\"number\" name=\"bucket[deadline]\" class=\"form-control\" value=\""
	    + alias4(((helper = (helper = helpers.deadline || (depth0 != null ? depth0.deadline : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"deadline","hash":{},"data":data}) : helper)))
	    + "\" />\n    </div>\n    <div>\n      tags: <input type=\"text\" name=\"bucket[tags]\" class=\"form-control\" value=\""
	    + alias4(((helper = (helper = helpers.tags || (depth0 != null ? depth0.tags : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"tags","hash":{},"data":data}) : helper)))
	    + "\" />\n    </div>\n  </fieldset>\n    <div class=\"bucketEditDeleteButtons modal-footer\">\n        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n      <button type=\"submit\" class=\"save-bucket-button btn btn-default close-modal\"  id=\""
	    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
	    + "\" data-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">Save Changes</button>\n    </div>\n</form>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(35),depth0,{"name":"all-buckets","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<h3>Buddies' Buckets</h3>\n"
	    + ((stack1 = helpers.blockHelperMissing.call(depth0,container.lambda((depth0 != null ? depth0.buckets : depth0), depth0),{"name":"buckets","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"usePartial":true,"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetUserProfile = function onGetUserProfile() {
	  $('#edit-profile-button').show();
	  return api.getProfile().then(ui.getProfileSuccess).catch(function (error) {
	    console.error(error);
	    $('.create-profile').show();
	    $('#all-buckets').html('');
	    $('#user-buckets').html('');
	...
	var onCreateProfile = function onCreateProfile(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  return api.createProfile(data).then(ui.createProfileSuccess).catch(function (error) {
	    return console.error(error);
	  });
	};
	...
	var onDeleteProfile = function onDeleteProfile(event) {
	  event.preventDefault();
	  return api.deleteProfile().then(ui.deleteProfileSuccess).catch(function (error) {
	    return console.error(error);
	  });
	};
	...
	var onUpdateProfile = function onUpdateProfile(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  return api.updateProfile(data).then(onGetUserProfile).then(ui.updateProfileSuccess).catch(function (error) {
	    return console.error(error);
	  });
	};

	var showUpdateProfile = function showUpdateProfile(event) {
	  event.preventDefault();
	  return api.getProfiles().then(ui.showUpdateSuccess).catch(function (error) {
	    return console.error(error);
	  });
	};
	...
	module.exports = {
	  addProfileHandlers: addProfileHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var viewProfileTemplate = __webpack_require__(40);
	var editProfileTemplate = __webpack_require__(41);
	...
	var showUpdateSuccess = function showUpdateSuccess(data) {
	  app.profile = data.profile;
	  // console.log(app.profile);
	  $('.update-profile').show();
	};

	var editProfileForm = function editProfileForm() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"table-responsive\">\n  <table class=\"table table-condensed table-bordered profile-table\">\n    <tr>\n      <td><h3 class=\"profile-username\">\n        "
	    + alias4(((helper = (helper = helpers.username || (depth0 != null ? depth0.username : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"username","hash":{},"data":data}) : helper)))
	    + "\n      </h3>\n      </td>\n    </tr>\n    <tr class=\"justify-items\">\n      <td style=\"padding: 0 50px;\">\n        <h4>"
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.name : depth0)) != null ? stack1.firstName : stack1), depth0))
	    + " "
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.name : depth0)) != null ? stack1.lastName : stack1), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<form id=\"update-profile\">\n  <div class=\"form-group\">\n    <legend>Edit your Profile</legend>\n    <h6>Your Name</h6>\n    <fieldset>\n      <input type=\"text\" class=\"form-control\" name=\"profile[name[firstName]]\" placeholder=\"First Name\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.name : depth0)) != null ? stack1.firstName : stack1), depth0))
	    + "\">\n      <input type=\"text\" class=\"form-control\" name=\"profile[name[lastName]]\" placeholder=\"Last Name\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.name : depth0)) != null ? stack1.lastName : stack1), depth0))
	    + "\">\n    </fieldset>\n  </div>\n  <hr>\n  <div class=\"form-group\">\n    <h6>Username</h6>\n    <fieldset>\n      <input type=\"text\" class=\"form-control\" name=\"profile[username]\" placeholder=\"Enter Username\" required value=\""
	    + alias2(((helper = (helper = helpers.username || (depth0 != null ? depth0.username : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"username","hash":{},"data":data}) : helper)))
	    + "\">\n    </fieldset>\n  </div>\n  <hr>\n  <div class=\"form-group\">\n    <h6>About Me</h6>\n    <fieldset>\n      <textarea class=\"form-control about-me\" name=\"profile[aboutMe]\" value=\""
	    + alias2(((helper = (helper = helpers.aboutMe || (depth0 != null ? depth0.aboutMe : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"aboutMe","hash":{},"data":data}) : helper)))
	    + "\"></textarea>\n    </fieldset>\n  </div>\n  <hr>\n  <div class=\"row\">\n    <div class=\"col-md-4\">\n      <div class=\"form-group\">\n        <h6>Location</h6>\n        <fieldset>\n          <input type=\"text\" class=\"form-control three-column\" name=\"profile[city]\" placeholder=\"City\" value=\""
	    + alias2(((helper = (helper = helpers.city || (depth0 != null ? depth0.city : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"city","hash":{},"data":data}) : helper)))
	    + "\">\n        </fieldset>\n      </div>\n    </div>\n    <div class=\"col-md-4\">\n      <div class=\"form-group\">\n        <h6>Gender</h6>\n        <fieldset>\n          <select name=\"profile[gender]\">\n            <option value=\"n\">No Answer</option>\n            <option value=\"f\">Female</option>\n            <option value=\"m\">Male</option>\n            <option value=\"o\">Other</option>\n          </select>\n        </fieldset>\n      </div>\n    </div>\n    <div class=\"col-md-4\">\n      <div class=\"form-group\">\n        <h6>Date of Birth</h6>\n        <fieldset>\n          <input class=\"form-control three-column\" name=\"profile[dob]\" placeholder=\"Date of Birth\" type=\"date\">\n        </fieldset>\n      </div>\n    </div>\n  </div>\n  <hr>\n  <div class=\"form-group\">\n    <button type=\"submit\" class=\"btn btn-primary\">Submit</button>\n  </div>\n</form>\n";
	},"useData":true});
